...
parser.add_argument("--file", type=str, default="wavefield/wavefield.txt", help="Path to the wavefield file")
parser.add_argument("--name", type=str, default="wavefield", help="Name of the image to be generated")
